...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'cafe-de-colombia', 'camomile-flowers', 'canary-islands', 'candy-world',
    ...
    'golden-gate', 'golden-horizon', 'golden-lights', 'golden-opportunity', 'grand-prix', 'great-idea',
    ...
    'invincible-zone', 'japan-emperor', 'jungle-nature', 'kilimanjaro-outskirts', 
    ...
    'pink-lady', 'pink-lake', 'pirate-ship', 
