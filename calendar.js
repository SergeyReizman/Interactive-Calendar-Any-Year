...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'art-studio', 'a-simple-task', 'a-thing-of-beauty', 'autumn-harvest', 'away-from-home',
    ...
    'island-breeze', 'invincible-zone', 'japan-emperor', 'jungle-nature',
    ...
    'sea-breeze', 'seabreeze-avenue', 'sea-diamonds', 'sea-lions', 'sea-star',
    ...
    'world-champion', 'work-of-art', 'your-wildest-dreams',
