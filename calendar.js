...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'bamboo-flute',
    'battle-of-the-ice', 'bermuda-triangle', 'best-practice', 'black-fashion', 'black-bird', 
    'black-coffee', 'black-hacker',
    'black-hawk', 'black-hole', 'black-orange', 'black-velvet', 'black-violet', 'blue-bird', 'blue-ice', 
    'blue-planet','blue-whale', 'blue-white', 'breaking-point', 
    ...
    'continuous-growth', 'coral-reef', 'cosmic-nebula', 'cracked-ice', 'crimson-sky', 'critical-thinking', 
    'crossroads-stone',
    ...
    'doterra-black', 'doterra-colors', 'dragon-flame', 'dragonfly','emerald-stream', 'emperor-penguin', 
