...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'doterra-black', 'doterra-colors', 'doterra-green', 
    ...
    'high-speed-rail', 'high-speed-train', 'high-style', 'hurricane-clouds', 'hyperloop', 'ice-palace',
    'iceland-volcanoes' , 
    ...
    'rainbow-dream', 'rainforest-jungle', 'rain-waltz', 'red-lake', 'red-squirrel', 'remote-island',
    'rising-sun',
