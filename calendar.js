...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'dragon-flame', 'dragonfly','emerald-stream', 'emperor-penguin', 'essential-oils', 'everest-view', 
    ...
    'greenland-icebergs', 'greyscale', 'guangzhou-lights', 'heavy-rain', 'hidden-trail', 'high-performance', 'hurricane-clouds', 
