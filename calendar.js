...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'continuous-growth', 'coral-reef', 'cracked-ice', 'crimson-sky', 'crossroads-stone', 'crystal-snowfall', 
    'crystal-stream',
    'cyber-pulse', 'dark-mode', 'dartagnans-rapier', 'daruma-doll', 'deep-forest', 'deep-ocean', 'desert-mirage', 'distant-skies', 
    ...
    'lemongrass-sky', 'life-quality', 'lions-mane', 'love-station', 'lucid-dream', 'lunar-eclipse', 'macaroni-penguin',
