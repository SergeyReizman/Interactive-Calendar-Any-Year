...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'exotic-island', 'executive-management','fast-track', 'fiji-islands',
    'finish-line', 'fir-balsam', 'flamingo-sky', 
    'free-flight', 'forgotten-dreams', 'frozen-wilderness', 'galactic-glow', 'genghis-khan-arrow',
    ...
    'iceland-volcanoes' , 
    'imaginary-world', 'in-the-dusk', 'into-the-night', 'invincible-zone', 'japan-emperor',
    'kilimanjaro-outskirts', 'lavender-bliss', 
    'lemongrass-sky', 'life-quality', 'lions-mane', 'love-station', 'lucid-dream', 'lunar-eclipse', 
    'macaroni-penguin',
    ...
    'polar-bear', 'porcupine-quill', 'port-victoria', 'practical-experience', 'pure-light', 
