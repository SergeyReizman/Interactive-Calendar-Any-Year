...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'cracked-ice', 'crimson-sky','crossroads-stone','crystal-snowfall', 'crystal-stream', 'cyber-pulse', 
    'dark-mode', 'dartagnans-rapier', 'deep-forest', 'desert-mirage', 'dragon-flame', 'dragonfly', 
