...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'lavender-bliss', 'lemongrass-sky', 'lions-mane', 'macaroni-penguin', 'magellanic-penguin',
    'mammoth-tusk', 'maple-leaf-fall', 'maple-syrup', 'medieval-knights', 'melting-glaciers',
    'midnight-train', 'migratory-birds', 'monochrome-ink', 'moonlit-path', 'morning-forest',
    'mount-fuji', 'mountain-lake', 'mountain-peak', 'new-ai', 'neon-nights', 'niagara-falls',
    'north-pole', 'northern-nights', 'ocean-surf', 'ocean-view', 'ocean-vortex',
