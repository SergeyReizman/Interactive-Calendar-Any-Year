...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'a-king-of-stone', 'alaska-glacial-water', 'aloe-vera', 'alone-in-paradise', 'a-lovely-day',
    ...
    'battle-of-the-ice', 'bermuda-triangle', 'best-of-technology', 'best-practice', 'best-response', 
    ...
    'black-orange', 'black-orchid', 'black-panther', 'black-pear', 'black-pearl', 'black-style',
    ...
    'coral-reef', 'core', 'cosmic-nebula', 'cosmic-perspective',
    ...
    'doterra-magic', 'doterra-natural', 'doterra-new', 'doterra-power', 'dragonfire',
    'dragon-flame', 'dragonfly', 'dragon-well', 'dramatic-coastline.css', 'dream-adventure', 
    'dream-islands', 'eagle-beach-aruba', 'eagle-creek', 'eagle-river','eagle-swoop', 
    'early-dreams', 'eco-friendly', 'eighty-mile-beach',
    ...
    'exotic-island', 'expedient-path', 'expedition-north', 'exponential-acceleration',  
    ...
    'mammoth-tusk', 'manchester-united', 'maple-leaf-fall', 'maple-syrup', 'medieval-knights',
    ...
    'purple-fog', 'purple-sunset', 'quantum-programmer', 'queen-of-ambience', 
    ...
    'saint-tropez-moon', 'san-francisco-lights', 'san-francisco-sunrise', 'science-fiction',
    ...
    'shaping-the-future', 'shift-in-perception', 'significant-improvement', 'silicon-valley', 
    ...
    'the-silver-sword', 'the-spirit-of-innovation', 'the-unstoppable-mindset', 'the-west-coast', 
    'the-world-of-nature', 'think-different', 'tide-of-dreams', 'tiger-design',
    ...
    'viking-helmet','viktoria-falls', 'watermelon', 'weekend-downtime', 'weekend-mindset',
