...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'black-fashion', 'black-bird', 'black-classic', 'black-coffee', 'black-hacker',
    ...
    'dream-islands', 'eagle-creek', 'eagle-river','eagle-swoop', 
    ...
    'mount-cook', 'mount-fuji', 'my-beautiful-village',
    'my-dream-country', 'my-dream-home',
    'my-tomorrow', 'natural-wonders', 'neon-nights',
    'new-ai', 'new-black', 'new-millenium', 'new-strategy', 'new-style', 
    ...
    'purple-fog', 'purple-sunset',
    'quantum-programmer', 'queen-of-ambience', 
    ...
    'street-fashion-style', 'strength-of-spirit', 'strings-of-sunrays', 'strong-foundation',
