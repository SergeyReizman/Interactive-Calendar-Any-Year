...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'blue-planet', 'blue-sky',
    'blue-stars', 'blue-whale', 'blue-white', 'blue-window',
    ...
    'cherry-garden', 'cinnamon-street', 'citrus-blaze', 'city-of-dreams', 'city-of-night', 
    ...
    'doterra-magic', 'doterra-new', 'doterra-power', 'dragonfire',
    ...
    'mount-cook', 'mount-fuji', 'my-dream-country', 'my-tomorrow', 
    'natural-wonders', 'neon-nights',
    ...
    'real-results', 'red-lake', 'red-squirrel', 'remote-island','right-on-track', 'rising-sun',
    ...
    'summer-breeze', 'sunset-magic', 'sweet-misty-morning',
    ...
    'the-hidden-jem', 'the-highest-level', 'the-highest-peak', 
