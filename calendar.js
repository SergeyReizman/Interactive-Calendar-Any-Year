...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'a-stunning-shoreline', 'at-the-perfect-moment', 'a-thing-of-beauty', 
    'atlantic-division', 'a-turning-point', 'autumn-harvest', 'away-from-home', 
    ...
    'black-friday', 'black-hacker', 'black-hawk', 'black-hole', 
    ...
    'coastal-pacific', 'coconut-islands', 'coconut-shores', 'code-red',
    'coffee-for-leaders', 'color-between-rain', 'color-of-my-dreams',
    'colors-of-a-dream', 'color-symphony', 'collaboration-idea', 'colombian-jungle', 
    'commmand-night', 'competitive-advantage', 'continuous-growth',
    ...
    'eagle-swoop', 'early-dreams', 'eco-friendly', 'edge-of-universe',
    'eighty-mile-beach', 'emerald-lake', 'emerald-ocean',
    'emerald-stream', 'emerald-water', 'emperor-penguin', 
    'enchanting-island', 'endless-horizon', 'endless-summer',
    'enjoy-the-journey', 'espresso-monaco',
    ...
    'fine-tuning', 'finish-in-style', 'finish-line', 'fir-balsam', 
    'fireplace-dream', 'first-project', 'flamingo-sky',
    'flamingo-sky', 'forgotten-dreams', 'formula-one',
    'for-the-last-time', 'forward-thinking', 'free-flight', 'free-imagination', 
    'fresh-market', 'fresh-start', 'frontier-unknown',
    'frozen-magic', 'frozen-wilderness', 'full-pink-moon', 'full-sunshine-mode', 
    'fun-activity', 'galactic-glow', 'game-changer', 'games-are-fun', 
    'gau-island', 'genghis-khan-arrow',
    'giant-petrel', 'global-impact', 'glorious-day', 'glowing-green-ocean-wave',
    'glow-in-the-dark', 'gold-coast', 'golden-century', 'golden-eagle',
    'golden-gate', 'golden-gate-bridge', 'golden-hillsides', 'golden-horizon', 'golden-langur',
    ...
    'great-lakes', 'greece-is-bliss', 'green-agent',
    'green-city', 'green-coffee', 'green-heaven',
    ...
    'hometown-vibes', 'hong-kong',
    'honolulu-hawaii', 'honolulu-weekend', 'hot-desert-summer',
    ...
    'in-adriatic-waters', 'in-broad-daylight',
    'indigo-jeans', 'in-my-control', 'in-my-style',
    'inspiration-line', 'intelligence-quotient', 
    'inter-miami', 'in-the-dusk', 'in-the-mountains',
    'in-the-raspberry-dawn', 'in-the-shade-of-green',
    'into-the-jungle', 'into-the-night', 'invincible-zone', 'in-your-dreams', 
    ...
    'kookaburra', 'koro-island', 'kuata-island', 'lady-blue', 
    'lakeba-island', 'lake-best-view', 'lake-mcdonald', 
    'land-of-angels', 'land-of-dreams', 'land-of-tomorrow', 
    ...
    'midnight-black', 'midnight-hour', 'midnight-jungle',
    'midnight-sun', 'midnight-train', 'midnight-elegance',
    'migratory-birds', 'mirror-lake', 'mission-completed', 
    'modern-technology', 'mogren-beach', 'moment-in-your-life', 
    'monochrome-ink', 'monte-carlo', 'montego-bay', 'moon-bridge',
    'moonlit-path', 'moonshot-idea',
    'morning-coffee', 'morning-forest', 'mountain-lake', 'mountain-landscape',
    ...
    'ninety-nine-nights', 'no-daylight-between-us',
    'no-place-like-home', 'northern-lights', 'northern-nights', 
    'north-pole', 'north-pole-icebreaker', 'not-just-luxury',
    'now-is-your-moment', 'nyc-in-bloom',
    'ocean-beach', 'ocean-dreams', 'ocean-drive', 'ocean-eleven', 
    'oceanfront-elegance', 'ocean-light',
    'ocean-parkway', 'ocean-surf', 'ocean-view',
    'ocean-view-drive', 'ocean-vortex', 'off-road-trip', 'okinawa-breeze', 'old-lighthouse',
    'olimpia-milano', 'on-a-roll',
    'once-in-a-lifetime', 'one-dream', 'one-point-of-reference',
    'one-step-ahead', 'one-step-at-a-time',
    'one-way-ticket', 'on-the-island', 'on-the-moon',
    'on-the-wild-side', 'orange-country',
    'orange-dragon', 'orion-constellation', 'our-favorite-hangout', 
    'out-in-the-wild', 'out-of-the-blue',
    ...
    'race-ready', 'rainbow-dream', 'rainforest-jungle', 
    'rain-gardens', 'rain-waltz', 'random-coincidence', 'real-madrid',
    'real-results', 'record-demand', 'red-agent', 'red-coast',
    'red-desert', 'red-grapefruit', 'red-lake', 
    'red-morning-light', 'red-squirrel', 'red-tape', 'remarkable-city',
    'remote-code-execution', 'remote-island', 'right-on-track', 'rising-sun', 
    ...
    'sea-breeze', 'seabreeze-avenue', 'sea-diamonds', 'seahorse', 
    'sea-lions', 'sea-star', 'secret-item',
    'secretive-ninja','secret-night', 'secret-paradise', 'selfless-programmer',
    ...
    'somewhere-in-fiji', 'south-sea-island', 'space-force', 'spark-of-knowledge', 
    ...
    'the-desert-line', 'the-distant-island',
    ...
    'the-red-city', 'the-right-shade-of-yellow',
    ...
    'tiger-design', 'time-complexity', 'time-machine', 'time-on-target',
    'time-to-chill', 'tokoriki-island','tokyo-at-night', 'tokyo-skytree',
