...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'fun-activity', 'galactic-glow', 'game-changer', 'games-are-fun', 'genghis-khan-arrow',
    ...
    'koro-island', 'lady-blue', 'lakeba-island', 'lake-mcdonald', 'land-of-dreams', 
    ...
    'ninety-nine-nights', 'no-place-like-home', 'northern-lights', 'northern-nights', 
