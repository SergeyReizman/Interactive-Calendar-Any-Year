...
const applyTheme = (theme) => {
  body.classList.remove(
    ...
    'battle-of-the-ice', 'bermuda-triangle', 'best-practice', 'black-coffee', 'black-hacker',
    ...
    'cardinals-guards', 'cherry-garden', 'cinnamon-street', 'competitive-advantage', 'cracked-ice', 
    'crimson-sky','crossroads-stone','crystal-snowfall', 'crystal-stream', 'cyber-pulse', 'dark-mode', 
    'dartagnans-rapier', 'deep-forest', 'desert-mirage', 'dragon-flame', 'dragonfly', 'emerald-stream',
    'emperor-penguin', 'everest-view', 'exotic-island', 'fast-track', 'fiji-islands', 'finish-line', 
    'fir-balsam','flamingo-sky', 'forgotten-dreams', 'galactic-glow', 'genghis-khan-arrow', 'giant-petrel',
    ...
    'melting-glaciers','midnight-train', 'migratory-birds', 'monochrome-ink', 'moonlit-path', 
    'morning-forest','mount-fuji', 'mountain-lake', 'mountain-peak', 'new-ai', 'neon-nights', 
    ...
    'port-victoria', 'porcupine-quill', 'pure-light', 'purple-fog', 'quiet-evening',
    ...
    'steel-shadows', 'stockholm-roofs', 'strategic-advantage', 'sword-of-fate', 'tactical-advantage', 
    'the-last-mohican','time-machine', 'tropical-sunset', 'viktoria-falls', 'viking-helmet', 
    'weekend-downtime','white-shark', 'wild-rose', 'wild-wonders', 'winter-wonderland'
